...
import { GET_ANNOUNCEMENT_BY_ID } from "../../url_helper";
import Cookies from "js-cookie";

const getAllAnnouncementById = async (props) => {
  ...
  const response = await get(GET_ANNOUNCEMENT_BY_ID, config);
  return response;
};

export default getAllAnnouncementById;
