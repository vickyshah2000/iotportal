...
import logo from "../../assets/images/Ajeevi-img/smalliot.png";
import logoLightSvg from "../../assets/images/shillong.png";
...
const Header = (props) => {
  ...
  return (
    <React.Fragment>
      <header id="page-topbar" style={{background:"#eff0f5", boxShadow: '0 4px 8px rgba(0, 0, 0, 0.3)'}} >
        <div className="navbar-header">
          <div className="d-flex">
            <div className="navbar-brand-box d-lg-none d-md-block" style={{height:"70px",background:"#eff0f5"}}>
                <span className="logo-sm">
                  <img src={logo} alt="" height="80" width="70" />
                </span>
