...
const EditDevice = () => {
  ...
  useEffect(() => {
    async function deviceMake() {
      const response = await fetchWithTokenRefresh({url:`${base_url3}/api/Entity/GetAllEntities`})
      const Alldata=response.data.data.filter((item,index)=>item.roleName=="Manufacturer")
      setMake(Alldata);
      // console.log(Alldata);
    }
    async function autoFill() {
      // const response = await fetchWithTokenRefresh({url: `${base_url}/api/master-device-type/${deviceId}/`})
      const response = await axios.get( `${base_url2}/api/MasterDeviceType/${deviceId}/`)
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      deviceMake: prev.make ,
      deviceModel: prev.model ,
    ...
    onSubmit: async (values) => {
      try {
       await axios.put(`${base_url2}/api/MasterDeviceType`,{
          id: deviceId,
                  ...
                  <Row>
                    <Col className="col-7">
                      <div className="text-primary p-4">
                        <h5 className="text-primary">Edit Device</h5>
                      </div>
                    </Col>
...
//   useEffect(() => {
//     async function deviceMake() {
//       const response = await fetchWithTokenRefresh({url:`${base_url}/api/entity/?names_only=True`})
//       setMake(response.data);
//       console.log(response.data,"fhdchjfjhfv");
//     }
//     async function autoFill() {
//       const response = await fetchWithTokenRefresh({url: `${base_url}/api/master-device-type/${deviceId}/`})
//       setPrev(response.data);
...
//           url: `${base_url}/api/master-device-type/${deviceId}/`,
//           body: {
