    ...
    const fetchData = async () => {
      try {
        const res = await fetchWithTokenRefresh({
          url: `${base_url4}/api/Device/get-all-device-info?entityId=${entityId}&deviceTypeId=8&pageNumber=${pageNumber}&pageSize=${customPageSize}`,
        });
  ...
  return (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs title="Tables" breadcrumbItem="Total Household" />
        <TableContainer
          columns={columns}
          data={data}
          isGlobalFilter={true}
...
RFIDTagDetails.propTypes = {
  preGlobalFilteredRows: PropTypes.any,
};

export default RFIDTagDetails;
