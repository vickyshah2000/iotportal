    ...
    const fetchData = async () => {
      try {
        const res = await fetchWithTokenRefresh({
          url: `${base_url4}/api/Device/get-all-device-info?entityId=${entityId}&deviceTypeId=12&pageNumber=${pageNumber}&pageSize=${customPageSize}`,
        });
  ...
  return (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs title="Tables" breadcrumbItem="Total RFID Reader" />
        <TableContainer
          columns={columns}
          data={data}
          isGlobalFilter={true}
...
RFIDReaderDetails.propTypes = {
  preGlobalFilteredRows: PropTypes.any,
};

export default RFIDReaderDetails;
