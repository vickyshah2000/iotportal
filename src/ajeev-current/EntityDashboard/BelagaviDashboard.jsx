...
const BelagaviDashboard = (props) => {
  ...
  document.title = "BelagaviDashboard";
          ...
          <Row className="align-items-center justify-content-center">
              ...
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    ...
                    <p className="text-muted fw-medium">Total Household </p>
                ...
                <Link className="text-dark ps-3" to="show-all-rfid-tag" style={{background:"#aab7f7"}}>
                  View Details
                </Link>
              </Card>
            </Col>
            <Col md="3">
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    <div className="flex-grow-1">
                    <p className="text-muted fw-medium">Collected</p>
            ...
            <Col md="3">
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    <div className="flex-grow-1">
                   <p className="text-muted fw-medium">Not Collected</p>
            ...
            <Col md="3">
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <p className="text-muted fw-medium">Total Vehicle</p>
                      <h4 className="mb-0">{totalDevices[1]?.totalCount||0}</h4>
                    </div>
                    <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                      <span className="avatar-title">
                      <i className="bx">🔵</i>
                ...
                <Link className="text-dark ps-3" to="show-all-gps" style={{background:"#aab7f7"}}>
                  View Details
                </Link>
              </Card>
            </Col>
            <Col md="3">
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <p className="text-muted fw-medium">Active Vehicle</p>
                      <h4 className="mb-0">{totalDevices[1]?.totalCounts||0}</h4>
                    </div>
                    <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                      <span className="avatar-title">
                      <i className="bx">🔵</i>
            ...
            <Col md="3">
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <p className="text-muted fw-medium">Inactive Vehicle</p>
                      <h4 className="mb-0">{totalDevices[1]?.totalCounts||0}</h4>
                    </div>
                    <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                      <span className="avatar-title">
            ...
            <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
              <CardBody>
                <div className="d-flex">
                  <div className="flex-grow-1">
                    <p className="text-muted fw-medium">Total RFID Reader</p>
                    <h4 className="mb-0">{totalDevices[2]?.totalCount||0}</h4>
                  </div>
                  <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                    <span className="avatar-title">
                    <i className="bx">🔵</i>
              ...
              <Link className="text-dark ps-3" to="show-all-rfid-reader" style={{background:"#aab7f7"}}>
                View Details
              </Link>
            </Card>
          </Col></>
          <Col md="3">
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <p className="text-muted fw-medium">Active RFID Reader</p>
                      <h4 className="mb-0">{totalDevices[1]?.totalCounts||0}</h4>
                    </div>
                    <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                      <span className="avatar-title">
            ...
            <Col md="3">
              <Card className="mini-stats-wid shadow-lg bg-body-tertiary rounded">
                <CardBody>
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <p className="text-muted fw-medium">Inactive RFID Reader</p>
                      <h4 className="mb-0">{totalDevices[1]?.totalCounts||0}</h4>
                    </div>
                    <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                      <span className="avatar-title">
...
BelagaviDashboard.propTypes = {
  t: PropTypes.any,
};

export default withTranslation()(BelagaviDashboard);
