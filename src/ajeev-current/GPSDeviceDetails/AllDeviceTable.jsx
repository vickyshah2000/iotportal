    ...
    const fetchData = async () => {
      try {
        const res = await fetchWithTokenRefresh({
          url: `${base_url4}/api/Device/get-all-device-info?entityId=${entityId}&deviceTypeId=10&pageNumber=${pageNumber}&pageSize=${customPageSize}`,
        });
  ...
  return (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs title="Tables" breadcrumbItem="GPS Table" />
        <TableContainer
          columns={columns}
          data={data}
          isGlobalFilter={true}
...
GPSDeviceDetails.propTypes = {
  preGlobalFilteredRows: PropTypes.any,
};

export default GPSDeviceDetails;
