...
const ForgetPasswordPage = (props) => {
  ...
  const validation = useFormik({
    ...
    onSubmit: async (values) => {
      const response = await changePass(values.email);
      if (response.detail == "Password reset instructions sent to your email") {
        setEmailSent(true);
        setForgetSuccess(response.detail);
      } else {
        setForgetError(response.detail);
      }
    },
  });

  // Ensure forgetError is a string
